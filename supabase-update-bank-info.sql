...
--
-- 既存の users を login_account で照合して更新します。
-- zip_code, address, bank_name, branch_name, account_type, account_number, account_holder, invoice_number, phone_number の
-- カラムが存在することを前提としています（supabase-migration-users-bank.sql を未実行の場合は先に実行してください）。
